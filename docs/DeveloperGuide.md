...
| `* *`    | Vim enthusiast MA1521 TA                   | manage student performance and credentials using only a command line                    | I can practice my vim and command lines skills while teaching the module                       |
