...
| `* *`    | MA1521 TA                                  | view a single students performance across assignments and attendance                     | I can track their progress over time                                                           |
| `* *`    | MA1521 TA using the app for the first time | tag students to their tutorial groups                                                    | I can differentiate between my different tutorial groups                                       |
...
| `*`      | Concerned MA1521 TA                        | generate a table or graphical summary of the student performance across the whole module | I can identify trends and intervene early when needed                                          |
| `*`      | Hardworking MA1521 TA                      | filter students by performance band                                                      | I can tailor my teaching strategies to specific cohorts                                        |
| `*`      | MA1521 TA                                  | view a summary of grades for an assignment                                               | I know the overall performance of my class                                                     |
| `*`      | CLI Experienced MA1521 TA                  | import previous student data (csv, etc.) into this new application                       | I can seamlessly continue my workflow without excessive data reformatting                      |
| `*`      | Intermediate MA1521 TA user                | add pictures / notes about my students                                                   | I will be able to remember them better and that it is more personal / intimate                 |
| `*`      | Lazy Experienced CLI user MA1521 TA        | customize commands and create shortcuts                                                  | I can access frequent tasks more easily and save time                                          |
| `*`      | Aesthetically oriented MA1521 TA           | change from light / dark mode                                                            | I can customize the appearance                                                                 |
| `*`      | Aesthetically oriented MA1521 TA           | change colour theme                                                                      | I can customize the appearance                                                                 |
| `*`      | Impatient MA1521 TA                        | command responses to appear within 1 second                                              | I can work quickly and efficiently                                                             |
| `*`      | forgetful MA1521 TA                        | see the schedule and venues of my classes at a glance                                    | I can be punctual for my classes                                                               |
| `*`      | forgetful MA1521 TA                        | set reminders for upcoming classes                                                       | I can be notified of my classes and not miss them                                              |
| `*`      | MA1521 TA using the app for the first time | allow the long commands to be broken into multiple parts                                 | I can be more familiarized with the commands                                                   |
| `*`      | Markdown-savvy MA1521 TA                   | write and render Markdown in each student's note section                                 | I can display headings, todos, lists, etc. in a nicely formatted manner                        |
| `*`      | MA1521 TA using the app for the first time | see if my command is wrong without clearing out the command if i typed it wrongly        | I can edit my command instead of retyping it                                                   |
| `*`      | MA1521 TA user either new or experienced   | see a preview of the command before executing the command                                | I can edit the command if the information is wrong                                             |
| `*`      | TA who likes using CLI                     | press up/down arrow to traverse through sent command history                             | I can easily repeat similar commands without copying and pasting every single time             |
